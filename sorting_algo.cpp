...
void sorting_algo::set_delay_time(double n) { delay_time = n; }
...
QString sorting_algo::get_name() { return name; }

void sorting_algo::set_alive(bool b) { is_alive = b; }

bool sorting_algo::is_active() { return is_alive; }
